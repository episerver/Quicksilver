...
<div class="wh100" style="padding-left:10px; padding-right:5px; padding-top:10px; padding-bottom:5px;">
    <asp:Label runat="server" ID="lblWarning" Font-Bold="true"><asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:SharedStrings, Tax_Import_Warning %>"/></asp:Label>
    <br /><br />
    <asp:Label runat="server" ID="lblImportDescription"><asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:SharedStrings, Tax_Import_Instructions %>"/></asp:Label><br /><br />
    <!-- START: Upload block -->
        ...
        <asp:TableRow>
            <asp:TableCell>
                <mc:FileUploadActions ID="fuActions" runat="server" FileUploadControlID="FileUpCtrl" 
                    ...
                    <ShowTextTemplate><div class="FileUploadAddBtnBlock"><img src='<%= Page.ResolveUrl("~/Apps/Shell/styles/Images/Uploader/document_add.png") %>' width="16" height="16" border="0" title="Add" align="middle" />&nbsp;<asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:SharedStrings, Add_New_File %>"/></div></ShowTextTemplate>
                    <HideTextTemplate><img src='<%= Page.ResolveUrl("~/Apps/Shell/styles/Images/Uploader/scrollup_hover.gif") %>' width="16" height="16" border="0" title="Hide" /><span class="FileUploadHideBlock">&nbsp;<asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:SharedStrings, Hide_Panel %>"/></span></HideTextTemplate>
                    <UploadTextTemplate><img src='<%= Page.ResolveUrl("~/Apps/Shell/styles/Images/Uploader/publish.gif") %>' width="16" height="16" border="0" title="Upload" /><span class="FileUploadUploadBlock">&nbsp;<asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:SharedStrings, Upload_File %>"/></span></UploadTextTemplate>
                ...
                <table border="0" cellpadding="5" cellspacing="0" width="100%" >
                    <tr>
                        <td style="width: 311px">
                            <b><asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:SharedStrings, Uploaded_File %>"/>:&nbsp;</b>
                        </td>
                    </tr>
        ...
        <asp:TableRow>
            <asp:TableCell Width="100%">
                ...
                <mc:FileUploadProgress ID="fuProgress" runat="server" FileUploadControlID="FileUpCtrl" 
                  ...
                  <WaitTemplate><i><asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:SharedStrings, Wait_For_Uploading_To_Start %>"/></i></WaitTemplate>
                    <InfoTemplate>
    ...
    <div style="padding-left:5px; padding-right:5px; padding-top:5px; padding-bottom:5px;">
        <div class="FileUploadFilesForSaving" style="height:20px;"><b><asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:SharedStrings, Files_Available_For_Import %>"/>:</b></div>
        <br />
        <asp:UpdatePanel ID="FilesPanel" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>
                <table>
                    <tr>
                        <td align="left">
                            <core:FileList ID="FilesControl" runat="server" KeyFieldIndex="1" GridAppId="Order" GridViewId="OrderFilesList-Import" SelectedBtnId='<%# btnImport.ClientID %>' />
                        </td>
                    </tr>
                </table>
            </ContentTemplate>

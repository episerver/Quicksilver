...
<div class="wh100" style="padding-left:10px; padding-right:5px; padding-top:10px; padding-bottom:5px;">
    <asp:Label runat="server" ID="lblWarning" Font-Bold="true"><asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:CoreStrings, MetaData_Db_Backup_Recommendation %>"/></asp:Label>
    <br /><br />
    <asp:Label runat="server" ID="lblImportDescription"><asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:CoreStrings, MetaData_Import_Instructions %>"/></asp:Label><br /><br />
    <!-- START: Upload block -->
        ...
        <asp:TableRow>
            <asp:TableCell>
                <mc:FileUploadActions ID="fuActions" runat="server" FileUploadControlID="FileUpCtrl" 
                    ...
                    <ShowTextTemplate><div class="FileUploadAddBtnBlock"><img src='<%= Page.ResolveUrl("~/Apps/Shell/styles/Images/Uploader/document_add.png") %>' width="16" height="16" border="0" title="Add" align="middle" />&nbsp;<asp:Literal ID="Literal9" runat="server" Text="<%$ Resources:SharedStrings, Add_New_File %>"/></div></ShowTextTemplate>
                    <HideTextTemplate><img src='<%= Page.ResolveUrl("~/Apps/Shell/styles/Images/Uploader/scrollup_hover.gif") %>' width="16" height="16" border="0" title="Hide" /><span class="FileUploadHideBlock">&nbsp;<asp:Literal ID="Literal7" runat="server" Text="<%$ Resources:SharedStrings, Hide_Panel %>"/></span></HideTextTemplate>
                    <UploadTextTemplate><img src='<%= Page.ResolveUrl("~/Apps/Shell/styles/Images/Uploader/publish.gif") %>' width="16" height="16" border="0" title="Upload" /><span class="FileUploadUploadBlock">&nbsp;<asp:Literal ID="Literal8" runat="server" Text="<%$ Resources:SharedStrings, Upload_File %>"/></span></UploadTextTemplate>
                ...
                <table border="0" cellpadding="5" cellspacing="0" width="100%" >
                    <tr>
                        <td style="width: 311px">
                            <b><asp:Literal ID="Literal6" runat="server" Text="<%$ Resources:SharedStrings, Uploaded_File %>"/>: </b>
                        </td>
                    </tr>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div align="left">
			                            ...
			                            <asp:LinkButton runat="server" ID="lbSaveFiles" Text="<%$ Resources:CoreStrings, MetaData_Save_The_File %>" CssClass="text"></asp:LinkButton>
		                            </div>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
        ...
        <asp:TableRow>
            <asp:TableCell Width="100%">
                ...
                <mc:FileUploadProgress ID="fuProgress" runat="server" FileUploadControlID="FileUpCtrl" 
                  ...
                  <WaitTemplate><i><asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:SharedStrings, Upload_Instructions %>"/></i></WaitTemplate>
                    <InfoTemplate>
                        <em><asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:SharedStrings, File_Uploading %>"/></em>
                    </InfoTemplate>
    ...
    <div style="padding-left:5px; padding-right:5px; padding-top:5px; padding-bottom:5px;">
        <div class="FileUploadFilesForSaving" style="height:20px;"><b><asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:CoreStrings, MetaData_Files_Available_For_Import %>"/>:</b></div>
        <br />
        <asp:UpdatePanel ID="FilesPanel" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>
                <table>
                    <tr>
                        <td align="left">
                            <core:FileList ID="FilesControl" runat="server" GridAppId='<%# AppId %>' GridViewId="CoreFilesList-Import" SelectedBtnId='<%# btnImport.ClientID %>' KeyFieldIndex="1" />
                        </td>
                    </tr>
                </table>
            </ContentTemplate>

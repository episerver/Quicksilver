<%@ Control Language="C#" AutoEventWireup="true" Inherits="Mediachase.Commerce.Manager.Asset.Tabs.MoveCopyTab" Codebehind="MoveCopyTab.ascx.cs" %>
    ...
    <tr>
        <td valign="middle" style="padding: 1px; width: 180px;">
            <asp:RadioButtonList RepeatDirection="Horizontal" ID="MoveCopyOption" runat="server" Visible="true">
                ...
                <asp:ListItem Value="Copy" Text="<%$ Resources:SharedStrings, copy_to_folder_colon %>"/>
            </asp:RadioButtonList>
        </td>
        <td style="padding: 1px; height: 50px;" align="left" valign="middle">
            <!-- Content Area -->
                <ComponentArt:ComboBox id="ComboBox1" runat="server"
                      ...
                      Width="230"
                      DropDownHeight="120"
                      DropDownWidth="227" RunningMode="Client" LoadingText="Loading...">
                      <ClientEvents>

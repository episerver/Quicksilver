...
namespace EPiServer.Reference.Commerce.Site.Features.Checkout.Controllers
{
    public class OrderConfirmationMailPageController : PageController<OrderConfirmationMailPage>
    {
        ...
        private OrderConfirmationViewModel<OrderConfirmationMailPage> CreateViewModel(OrderConfirmationMailPage currentPage, PurchaseOrder order)
        {
            var hasOrder = order != null;

            if (!hasOrder)
            {
                return new OrderConfirmationViewModel<OrderConfirmationMailPage> { CurrentPage = currentPage };
            }
            ...
            OrderConfirmationViewModel<OrderConfirmationMailPage> viewModel = new OrderConfirmationViewModel<OrderConfirmationMailPage>
            {

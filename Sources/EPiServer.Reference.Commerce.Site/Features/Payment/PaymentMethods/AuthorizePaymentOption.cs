...
namespace EPiServer.Reference.Commerce.Site.Features.Payment.PaymentMethods
{
    ...
    public class AuthorizePaymentOption : PaymentOptionBase, IDataErrorInfo
    {
        ...
        public AuthorizePaymentOption(LocalizationService localizationService,

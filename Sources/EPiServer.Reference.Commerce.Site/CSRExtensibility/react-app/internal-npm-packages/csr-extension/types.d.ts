...
declare const HttpRequest: import("axios").AxiosInstance;
declare const CSRExtension: {
    InitConfiguration: (setting: AppSettingState) => void;
};
export { AppSettingState, HttpRequest, CSRExtension };

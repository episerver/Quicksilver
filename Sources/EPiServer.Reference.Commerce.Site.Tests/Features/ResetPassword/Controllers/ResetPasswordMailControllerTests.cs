...
namespace EPiServer.Reference.Commerce.Site.Tests.Features.ResetPassword.Controllers
{
    ...
    public class ResetPasswordMailControllerTests
    {
        ...
        public void Setup()
        {
            ...
            Mock<UserService> userServiceMock = new Mock<UserService>(userManagerMock.Object, signinManagerMock.Object, authenticationManager.Object, localizationService);
